...
- **Latest Build**: `MyBartenderAI-TodaysSpecial-NoNotifications-nov10.apk` (54MB, Nov 10 2025)
- **Authentication**: ✅ MSAL integration working
- **Backend Integration**: ✅ Azure Functions connected with secure key management
- **UI/UX**: ✅ Home screen reorganized with Today's Special feature (Nov 10)
- **Security**: ✅ Function key rotated and stored in Azure Key Vault
- **Today's Special**: ✅ Random daily cocktail selection with midnight refresh
...
### Today's Special Feature (November 10, 2025)

- ✅ **Random Daily Cocktail**: Implemented Today's Special with random cocktail selection
- ✅ **Daily Caching**: Uses SharedPreferences to cache selection for entire day
- ✅ **Midnight Refresh**: Automatic timer refreshes selection at local midnight
- ✅ **UI Display**: Shows cocktail name, category, and tags in prominent card
- ⏳ **Notifications**: 5pm daily notifications temporarily disabled (plugin compatibility issues)
- ✅ **Build Configuration**: Added core library desugaring support to `build.gradle.kts`
...
- **Today's Special**: Random daily cocktail feature with midnight refresh
...
- **Smart Scanner**: Image recognition for bottles (implementation complete, testing in progress)
- **Create Studio**: Custom cocktail creation (implementation complete, testing in progress)
...
- **Push Notifications**: Daily 5pm notifications for Today's Special (postponed - causes feature instability)
...
9. `mybartenderai-secure.apk` - Secure key management (Nov 6, 53MB)
10. `MyBartenderAI-TodaysSpecial-nov10.apk` - Today's Special feature (Nov 10, 54MB) - initial build
11. `MyBartenderAI-TodaysSpecial-FIXED-nov10.apk` - Today's Special working (Nov 10, 54MB)
12. `MyBartenderAI-TodaysSpecial-NoNotifications-nov10.apk` - **CURRENT BUILD** (Nov 10, 54MB) - Today's Special ✅ (notifications postponed)
...
- Smart Scanner feature testing incomplete
- Create Studio feature testing incomplete
- iOS version not yet built
- Premium tier subscription logic not implemented
- Push notifications blocked by flutter_native_timezone plugin compatibility issues
