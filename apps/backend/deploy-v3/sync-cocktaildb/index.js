...
const sqliteSnapshotBuilder_js_1 = require("../services/sqliteSnapshotBuilder.js");
...
const syncCocktailDb = async (timer, rawContext) => {
    ...
    try {
        ...
        const snapshot = await (0, sqliteSnapshotBuilder_js_1.buildSqliteSnapshot)();
...
exports.syncCocktailDb = syncCocktailDb;
functions_1.app.timer('sync-cocktaildb', {
    schedule: '0 30 3 * * *',
    handler: exports.syncCocktailDb,
});
