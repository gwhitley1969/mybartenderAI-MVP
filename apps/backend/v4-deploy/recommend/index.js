...
exports.recommendHandler = void 0;
...
const requestSchema = zod_1.z
    ...
    .strict();
const openAiService = new openAIRecommendationService_js_1.OpenAIRecommendationService();
...
exports.recommendHandler = recommendHandler;
...
functions_1.app.http('recommend', {
    ...
    route: 'v1/recommend',
    authLevel: 'function',
    handler: exports.recommendHandler,
});
