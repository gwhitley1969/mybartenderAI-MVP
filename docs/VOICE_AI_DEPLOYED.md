...
### Business Model
- **Subscribers**: 60 minutes/month included ($3.99/month or $39.99/year)
...
- **Margin**: ~$0.99 per subscriber after 30% app store cut
...
```javascript
const MONTHLY_VOICE_SECONDS = 3600;  // 60 minutes for subscribers at $3.99/mo
