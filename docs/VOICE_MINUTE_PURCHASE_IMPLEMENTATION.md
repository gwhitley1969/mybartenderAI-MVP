...
Enable subscribers to purchase additional voice minutes ($4.99 for 60 minutes) via Google Play Billing.
...
| paid (subscriber) | 60/month | Yes | $4.99 per 60 minutes add-on |
